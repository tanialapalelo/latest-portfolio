...
The receiver gets a link to a playable claw machine. As they grab items, they see mood-based clues like "something cozy" without ever seeing the budget or exact gift names. It's a discovery experience, not a shopping list.
